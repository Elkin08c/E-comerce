        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-end justify-between mb-10 gap-4">
              <div>
                <h2 className="text-3xl font-bold tracking-tight mb-2">Catálogo Completo</h2>
                <p className="text-muted-foreground">Explora nuestra gama completa de soluciones industriales</p>
              </div>
            </div>
            <ProductGrid />
          </div>
